...
// Memory leaks, don't use malloc() for scalars
// visualize for multiples of dt
// loop fusion! (at least on the boundaries)
// pow() --> x*x
// be careful of boundary conditions evaluation order
